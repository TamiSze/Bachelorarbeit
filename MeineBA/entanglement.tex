...
%		\end{equation}
% it´s better with a handy marko
		\begin{equation}
			\rho=\bra{\psi}\ket{\psi},
		\end{equation}
	...
	Its properties are:
%	\FloatBarrier
\todo{why a floatbarrier?}
%nutze hier enumerate
	...
	\end{enumerate}
	\FloatBarrier
	Now, let's have a look at an entangled state written in the two-qubit state:\todo{warum steht links bra und rechts ket?}
		\begin{equation}
